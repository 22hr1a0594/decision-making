...
student_type = input("Enter student type (MSDS, MSH, MGSDS, MGSH): ").strip()
tuition_fee = float(input("Enter the tuition fee (Rs.): "))
additional_fee = float(input("Enter the bus or hostel fee (Rs.): "))
total_fee = 0.0
